...
router.get('/dashboard/markdone/:id', isLoggedIn, dashboardController.markTaskAsDone);
router.post('/dashboard/markdone/:id', isLoggedIn, dashboardController.markTaskAsDone);
